...
import { Database, Bell, Moon, Sun, Upload, Key, FileText, Download, Brain, Phone, BookOpen, Shield, ScrollText, Loader2, ClipboardCheck, RefreshCw, AlertTriangle, FlaskConical, Lock, Microscope, GraduationCap } from 'lucide-react';
