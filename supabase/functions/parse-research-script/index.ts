...
Given the raw text of a Word document containing survey questions, extract and return structured data using the provided tool.

Rules:
- Identify any opening/greeting text as intro_script. If none exists, generate a professional one using {agent_name} as a placeholder for the researcher's name.
...
- Generate a short ai_extraction_hint for each question (e.g., "nps_score", "satisfaction_reason", "improvement_suggestion")
      ...
      "https://ai.gateway.lovable.dev/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            { role: "user", content: `Parse this document into a research script:\n\n${text}` },
          ],
          tools: [
            {
              type: "function",
              function: {
                ...
                description: "Create a structured research script from parsed document text",
                parameters: {
                  type: "object",
                  properties: {
                    ...
                    questions: {
                      ...
                      items: {
                        ...
                        properties: {
                          ...
                          ai_extraction_hint: { type: "string" },
                        },
                        required: ["order", "question", "type", "required", "ai_extraction_hint"],
