 ...
 serve(async (req) => {
   ...
   try {
    ...
    await logApiCost(supabase, {
      ...
      token_source: ("tokenSource" in geminiResult ? geminiResult.tokenSource : undefined),
    ...
    await logApiCost(supabase, {
      ...
      token_source: ("tokenSource" in deepseekResult ? deepseekResult.tokenSource : undefined),
